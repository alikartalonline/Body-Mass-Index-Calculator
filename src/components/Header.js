...

            {
                page === false ?
                    <div className="alert alert-primary d-flex align-items-center mt-5" role="alert">
                        ...
                        <div>
                            Hesaplama ekranına geri dönmek isterseniz <button type="button" className='btn btn-danger btn-sm' disabled>Reset</button> butonuna basınız ve tekrardan aynı işlemleri tekrarlayabilirsiniz.
                        </div>
                    </div> : null
            }
        </header>
