...
function GifContent({ bmi, resultGif, gifZ, gifN, gifF, gifS, gifAS, setResultGif, setGifZ, setGifN, setGifF, setGifS, setGifAS, resetOnClick }) {
    ...
    // console.log("bmi deneme", bmi.toFixed(2))
    console.log("resultGif :", resultGif)
    console.log("gifZ :", gifZ)
    console.log("gifN :", gifN)
    console.log("gifF :", gifF)
    console.log("gifS :", gifS)
    console.log("gifAS :", gifAS)
